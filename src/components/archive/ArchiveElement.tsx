    ...
    return (
        ...
        >
            <div
                ...
                className="grid items-center cursor-pointer grid-cols-[1fr_1fr_2fr] md:grid-cols-[1fr_1fr_1fr_4fr]"
            >
                ...
                <p className="overflow-hidden items-center pr-2 text-right whitespace-nowrap text-ellipsis">
                    {name}
                </p>
            </div>
            <AnimatePresence>
