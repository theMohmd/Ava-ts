...
export const Stop2Icon = ({ className, stroke = "white" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export const UploadIcon = ({ fill = "white", className }) => {
    return (
        <svg
            className={className}
            width="20"
...
export const ChainIcon = ({ fill = "white", className }) => {
    return (
        <svg
            width="17"
            height="21"
...
export const WordIcon = ({ className }) => {
    return (
        <svg
            className={className}
            width="13"
