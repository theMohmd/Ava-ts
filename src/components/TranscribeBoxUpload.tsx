...
const TranscribeBoxUpload = () => {
    return (
        <div className="flex relative flex-col justify-center items-center p-2 rounded-xl border-2 border-dashed border-cgreen">
            ...
            <p dir="rtl" className=" text-sm mt-5 text-gray-400">برای بارگذاری فایل گفتاری (صوتی/تصویری)، دکمه را فشار دهید یا فایل را داخلی خط‌چین بکشید <br/>متن پیاده شده آن، در اینجا ظاهر می‌شود</p>
        </div>
    );
};
