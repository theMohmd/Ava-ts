const Home = () => {
    return (
        <div
            dir="rtl"
            className="[&_p]:mt-4 [&>p]:dark:text-neutral-300 [&>p]:text-neutral-600 [&_div]:text-white [&_h3]:text-2xl dark:text-white text-center pt-20 px-10 "
        >
            ...
            <div className="flex flex-col gap-4 mt-8 md:flex-row">
                <div className="alefbaBg rounded-xl p-4">
